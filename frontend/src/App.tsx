  ...
  return (
    <div className="min-h-screen bg-bg p-6 flex items-center justify-center">
      <Card className="max-w-lg">
        ...
        <p className="text-[16px] leading-relaxed text-ink-2 mb-4">請先完成以下步驟：</p>
        <ol className="text-[16px] leading-relaxed text-ink-2 space-y-2 list-decimal list-inside mb-4">
          ...
          <li>
            執行 <code className="px-1 bg-hint rounded">initSheets()</code> 建立分頁
          </li>
          <li>「部署 → 網頁應用程式 → 所有人」取得 URL</li>
          <li>
            將 URL 填入{' '}
            <code className="px-1 bg-hint rounded">frontend/src/config.ts</code> 或用環境變數{' '}
